 ...
 * ------------------------ */
   ...
   */
   ...
   public function SingularValueDecomposition(Arg:KMatrix) {
      ...
      */
      ...
      s = Maths.make1DArray( int(Math.min(m+1,n)) );
      
      U = Maths.make2DArray(m,nu);
      V = Maths.make2DArray(n,n);
      var e:Array=  Maths.make1DArray(n);
      var work:Array= Maths.make1DArray(m);
 ...
 * ------------------------ */
   ...
   */
   ...
   public function getU():KMatrix {
        return KMatrix.makeUsingArray(U,m,Math.min(m+1,n));
   }
   ...
   */
   ...
   public function getV():KMatrix {
      return KMatrix.makeUsingArray(V,n,n);
   }
